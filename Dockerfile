...
USER root
RUN chown user /home/user/ -R && chown user /home/user/hostcwd -R

USER ${USER}

RUN buildozer android debug || cp -v /home/user/hostcwd/.buildozer/android/platform/build/dists/inpycon/bin/PyConIndia2018-0.4-debug.apk .
